...
const Banner = () => {
    return (
        <div className='bg-black p-10 lg:p-20'>
            <div className="hero  border-gray-700 border  bg-gray-900 rounded-xl lg:p-15 ">
  <div className="hero-content lg:gap-30 flex-col lg:flex-row-reverse">
    ...
    <div>
      ...
      <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold text-white">TRAIN WITH INTENT. LOG <br></br> EVERY SET.</h1>
