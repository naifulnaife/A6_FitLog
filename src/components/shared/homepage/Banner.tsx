...
const Banner = () => {
  ...
  <div className="hero-content lg:gap-30 flex-col lg:flex-row-reverse">
    ...
    <div>
      ...
      <p className="py-6 text-gray-400">FitLog is a dark, no-nonsense gym companion: pick a lift, lock it <br></br> into today's plan, and watch the week's work add up.</p>
